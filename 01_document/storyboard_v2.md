...
![캐릭터 시트 — 상우](../03_images/character_sheet_sangwoo_v2_fixed.png)
...
**이미지 생성 (Gemini)**
- [ ] 씬 1-A : 화가의 손 → `03_images/scene01A_painter.png`
- [ ] 씬 1-B : 피아니스트의 손 → `03_images/scene01B_pianist.png`
- [ ] 씬 1-C : 작가의 손 → `03_images/scene01C_writer.png`
- [ ] 씬 2 : AI 파티클 수렴 → `03_images/scene02_ai_learning.png`
- [ ] 씬 3 : 실루엣 창작자 → `03_images/scene03_creator.png`
- [ ] 씬 4 : 공존 일러스트 → `03_images/scene04_coexist.png`

**영상 변환 (Runway)**
- [ ] 씬 1-A → `02_sorce/scene01A_motion.mp4`
- [ ] 씬 1-B → `02_sorce/scene01B_motion.mp4`
- [ ] 씬 1-C → `02_sorce/scene01C_motion.mp4`
- [ ] 씬 2 → `02_sorce/scene02_motion.mp4`
- [ ] 씬 3 → `02_sorce/scene03_motion.mp4`
- [ ] 씬 4 → `02_sorce/scene04_motion.mp4`
